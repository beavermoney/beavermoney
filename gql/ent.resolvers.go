...
/*
	func (r *Resolver) CreateHouseholdInput() CreateHouseholdInputResolver {
	return &createHouseholdInputResolver{r}
}
type createHouseholdInputResolver struct{ *Resolver }
*/
