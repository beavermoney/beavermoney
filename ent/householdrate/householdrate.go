...
const (
	// Label holds the string label denoting the householdrate type in the database.
	Label = "household_rate"
	...
	// Table holds the table name of the householdrate in the database.
	Table = "household_rates"
	// HouseholdTable is the table that holds the household relation/edge.
	HouseholdTable = "household_rates"
