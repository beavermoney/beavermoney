...
func (_c *UserCreate) AddRecurringSubscriptionIDs(ids ...int) *UserCreate {
...
func (_c *UserCreate) AddRecurringSubscriptions(v ...*RecurringSubscription) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddSnapshotEntryIDs(ids ...int) *UserCreate {
	_c.mutation.AddSnapshotEntryIDs(ids...)
	return _c
}

// AddSnapshotEntries adds the "snapshot_entries" edges to the SnapshotEntry entity.
func (_c *UserCreate) AddSnapshotEntries(v ...*SnapshotEntry) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
