...
func (_c *CurrencyCreate) AddRecurringSubscriptionIDs(ids ...int) *CurrencyCreate {
...
func (_c *CurrencyCreate) AddRecurringSubscriptions(v ...*RecurringSubscription) *CurrencyCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
