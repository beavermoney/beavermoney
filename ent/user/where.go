...
func HasInvestments() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasInvestmentsWith(preds ...predicate.Investment) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasRecurringSubscriptions() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasRecurringSubscriptionsWith(preds ...predicate.RecurringSubscription) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasSnapshotEntries() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSnapshotEntriesWith(preds ...predicate.SnapshotEntry) predicate.User {
	return predicate.User(func(s *sql.Selector) {
